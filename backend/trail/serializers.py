...
class CitaSerializer(serializers.ModelSerializer):
    ...
    ruta_dificultad = serializers.CharField(source='ruta.nivel_experiencia', read_only=True)  # ✅ NUEVO
    ...
    class Meta:
        model = Cita
        fields = [
            'id', 'usuario', 'usuario_nombre', 'ruta', 'ruta_nombre', 'ruta_dificultad',  # ✅ Agregado ruta_dificultad
